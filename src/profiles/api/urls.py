...
urlpatterns = [
    ...
    url(r'(?P<pk>\d+)/albums/(?P<album_id>\d+)/images/(?P<image_id>\d+)/tags/create/?$', CreateTagAPI.as_view(), name='profile-album-image-tags-create'),
    ...
    url(r'(?P<pk>\d+)/albums/(?P<album_id>\d+)/images/create/?$', CreateImageAPI.as_view(), name='profile-album-images-create'),
    ...
    url(r'(?P<pk>\d+)/albums/create/?$', CreateAlbumAPI.as_view(), name='albums-create'),
